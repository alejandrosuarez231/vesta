...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <div class="form-row">
        <div class="form-group mr-2">
          {!! Form::label('formula_largo', 'Formula Area', ['class'=>'form-control-label']) !!}
          {!! Form::text('formula_largo', null, ['class'=>'form-control','placeholder'=>'Formula Area']) !!}
        </div>
        <div class="form-group mr-2">
          {!! Form::label('formula_ancho', 'Formula Area', ['class'=>'form-control-label']) !!}
          {!! Form::text('formula_ancho', null, ['class'=>'form-control','placeholder'=>'Formula Area']) !!}
        </div>
        <div class="form-group mr-2">
