...
<script>
  var app = new Vue({
    ...
    data: {
      complementos: [{modulo_id: '{{ $piezas_modulo->first()->modulo_id }}', producto: '', categoria_id: '', cantidad: 0}],
    },

    methods: {
      addRowComplemento: function (index) {
        this.complementos.splice(index + 1, 1, {modulo_id: '{{ $piezas_modulo->first()->modulo_id }}', producto: null, categoria_id: null, cantidad: 0});
      },
