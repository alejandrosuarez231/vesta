...
class SubtiposSeeder extends Seeder
{
    ...
    public function run()
    {
      $subtipos = collect([
        ...
        ['tipo_id' => 3, 'nombre' => 'Correderas Cocina', 'acronimo' => 'CC', 'largo' => 1],
        ['tipo_id' => 3, 'nombre' => 'Correderas Undermount', 'acronimo' => 'CU', 'largo' => 1],
        ['tipo_id' => 3, 'nombre' => 'Correderas Full Extension', 'acronimo' => 'CF', 'largo' => 1],
        ['tipo_id' => 3, 'nombre' => 'Correderas Simples', 'acronimo' => 'CS', 'largo' => 1],
        ['tipo_id' => 4, 'nombre' => 'Aglomerado HR', 'acronimo' => 'HR', 'ancho' => 1, 'largo' => 1, 'espesor' => 1, 'color' => 1],
        ['tipo_id' => 4, 'nombre' => 'Aglomerado', 'acronimo' => 'ST', 'ancho' => 1, 'largo' => 1, 'espesor' => 1, 'color' => 1],
        ['tipo_id' => 4, 'nombre' => 'MDF', 'acronimo' => 'MD', 'ancho' => 1, 'largo' => 1, 'espesor' => 1, 'color' => 1],
        ...
        ['tipo_id' => 9, 'nombre' => 'Perfil Gola Tipo "C"', 'acronimo' => 'GO', 'largo' => 1, 'color' => 1],
        ['tipo_id' => 9, 'nombre' => 'Perfil Gola Tipo "L"', 'acronimo' => 'GO', 'largo' => 1, 'color' => 1],
        ['tipo_id' => 9, 'nombre' => 'Tirador', 'acronimo' => 'TI', 'largo' => 1],
