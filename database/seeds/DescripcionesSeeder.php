...
class DescripcionesSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('descripciones')->insert([
            ...
            ['materiale_id' => 2, 'descripcion' => 'Puerta Gaveta', 'flargo' => NULL, 'fancho' => 'A-2'],
            ['materiale_id' => 2, 'descripcion' => 'Frente Gaveta', 'flargo' => 'A-((2*CR)+(2*EC)+(2*EG))', 'fancho' => NULL],
            ['materiale_id' => 4, 'descripcion' => 'Gav Trasera', 'flargo' => 'A-((2*CR)+(2*EC)+(2*EG))', 'fancho' => NULL],
            ['materiale_id' => 4, 'descripcion' => 'Gav Lateral', 'flargo' => 'P-(EC+EF)', 'fancho' => NULL],
