...
class CreateTablerosTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('tableros', function (Blueprint $table) {
            ...
            $table->decimal('4',8,2)->nullable();
            $table->decimal('15',8,2)->nullable();
            $table->decimal('16',8,2)->nullable();
            $table->decimal('18',8,2)->nullable();
            $table->decimal('19',8,2)->nullable();
            $table->decimal('25',8,2)->nullable();
            $table->timestamps();
            $table->softDeletes();
        });
    }
